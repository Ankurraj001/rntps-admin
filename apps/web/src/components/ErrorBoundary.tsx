...
export class ErrorBoundary extends Component<Props, State> {
  ...
  override render(): ReactNode {
    ...
    return (
      <div className="flex min-h-full items-center justify-center p-4 pb-badge sm:p-6 sm:pb-badge">
        <div className="w-full max-w-md rounded-lg border border-red-200 bg-white p-4 sm:p-6 text-center shadow-sm">
